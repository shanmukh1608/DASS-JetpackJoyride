...
class entity():
    ...
    def updateBoard(self, mat, flag="empty"):
        text = " Score: " + str(globalobjects.score) + " || Lives: " + str(globalobjects.lives) + " || Shield: " + ("Ready" if globalobjects.shieldAvailable == True else "Not Ready") + (" || Time Left: " + str(globalobjects.timeleft) if globalobjects.timeleft > 0 else " || Boss Fight!")
